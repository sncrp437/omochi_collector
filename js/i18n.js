...
const translations = {
    en: {
        ...
        legalLabel: 'Legal',
        loginOrRegisterBtn: 'Log In / Register',
        ...
        resetPasswordSuccess: 'Check your email for the reset link!',
        resetPasswordError: 'Failed to send reset link. Please try again.',
        resetPasswordRateLimit: 'Too many requests. Please wait before trying again.',
        deleteAccountTitle: 'Delete Account',
        deleteAccountWarning: 'Account deletion is handled through support to ensure safe data removal.',
        deleteAccountInstructions: 'Contact info@omochiapp.com with your account email.',
    ...
    ja: {
        ...
        accountLabel: 'アカウント',
        legalLabel: '法的情報',
        loginOrRegisterBtn: 'ログイン / 登録',
        resetPasswordLink: 'パスワードをリセット',
        deleteAccountLink: 'アカウントを削除',
        resetPasswordTitle: 'パスワードリセット',
        resetPasswordHint: 'メールアドレスを入力してください。リセット用リンクを送信します。',
        sendResetLinkBtn: 'リセットリンクを送信',
        resetPasswordSuccess: 'メールを確認してください！リセットリンクを送信しました。',
        resetPasswordError: '送信に失敗しました。もう一度お試しください。',
        resetPasswordRateLimit: 'リクエストが多すぎます。しばらくお待ちください。',
        deleteAccountTitle: 'アカウント削除',
        deleteAccountWarning: 'アカウント削除はサポートを通じて安全に処理されます。',
        deleteAccountInstructions: 'info@omochiapp.comにアカウントのメールアドレスを添えてご連絡ください。',
